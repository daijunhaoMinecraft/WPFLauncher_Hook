namespace Mcl.Core.Tools
{
    ...
    {
        // 标记位：第32位 (2147483648)
        private const uint MobilePlatformFlag = 1u << 31; 
        
        // 掩码位：去掉第32位的剩余部分 (2147483647)
        private const uint BaseUidMask = ~MobilePlatformFlag; 
        ...
        {
            return (uid & MobilePlatformFlag) != 0;
        }
