...
public class RandomDevicesInfo : IMethodHook
{
    ...
    [HookMethod("WPFLauncher.Manager.aqm")]
    ...
    public static string g()
    {
        ...
        try
        {
            if (text == null || text.Length != 8) text = RandomStr(8).ToUpper();
    ...
    public static string e(string kxr)
    {
        ...
        try
        {
            if (text == null || text.Length != 0x10) text = RandomStr(0x10).ToUpper();
            text += kxr;
            if (text.Length > 0x18) text.Substring(0, 0x18);
