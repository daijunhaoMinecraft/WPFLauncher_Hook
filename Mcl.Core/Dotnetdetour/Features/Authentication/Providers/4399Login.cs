...
internal class _4399
{
        ...
        string captchaId = null)
    {
        ...
        try
        {
            ...
            var oauthParams = Task.Run(() => ParamsAsync()).Result;
    ...
    public class LoginResult
    {
        ...
        {
            return new LoginResult { Success = true, SauthJson = sauthJson };
        }

        public static LoginResult Fail(string error)
        {
            return new LoginResult { ErrorMessage = error };
        }
    ...
    public class RegisterResult
    {
        ...
        {
            return new RegisterResult { ErrorMessage = error };
        }
