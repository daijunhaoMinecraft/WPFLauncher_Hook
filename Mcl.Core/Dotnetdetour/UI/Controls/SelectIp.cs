...
public class SelectIp : Form
{
    ...
    private readonly Font MonoFont = new("Consolas", 11F, FontStyle.Bold);
    private readonly Color SuccessColor = Color.FromArgb(16, 124, 16);

    private readonly Color ThemeColor = Color.FromArgb(0, 120, 215);
    private readonly Font TitleFont = new("Microsoft YaHei", 10.5F, FontStyle.Bold);
    ...
    private void InitializeComponent()
    {
        ...
        headerPanel = new Panel
            { Dock = DockStyle.Top, Height = 60, BackColor = Color.White, Padding = new Padding(20, 0, 0, 0) };
        var titleLabel = new Label
        {
            Text = "虚拟网卡 IP 配置", Font = TitleFont, ForeColor = Color.FromArgb(32, 32, 32),
            TextAlign = ContentAlignment.MiddleLeft, Dock = DockStyle.Fill
        };
        headerPanel.Controls.Add(titleLabel);
        Controls.Add(headerPanel);

        var line = new Label { Dock = DockStyle.Top, Height = 1, BackColor = Color.FromArgb(220, 220, 220) };
        Controls.Add(line);

        // --- 输入区 ---
        var instructionLabel = new Label
        {
            Text = "请输入主机位 (0-255):", Location = new Point(25, 80), Size = new Size(300, 20),
            ForeColor = Color.FromArgb(64, 64, 64)
        };
        Controls.Add(instructionLabel);

        var ipContainer = new Panel
        {
            Location = new Point(25, 105), Size = new Size(290, 35), BackColor = Color.White,
            BorderStyle = BorderStyle.FixedSingle
        };

        prefixLabel = new Label
        {
            Text = IpPrefix, Location = new Point(10, 0), Size = new Size(75, 33),
            TextAlign = ContentAlignment.MiddleRight, Font = MonoFont, ForeColor = Color.FromArgb(64, 64, 64),
            BackColor = Color.White
        };

        lastOctetTextBox = new TextBox
        {
            Location = new Point(90, 5), Size = new Size(60, 25), BorderStyle = BorderStyle.None, Font = MonoFont,
            TextAlign = HorizontalAlignment.Center, MaxLength = 3
        };
        lastOctetTextBox.KeyPress += (s, e) =>
        {
        ...
        Controls.Add(ipContainer);

        // --- 状态 ---
        statusLabel = new Label
        {
            Location = new Point(25, 145), Size = new Size(290, 20), ForeColor = ErrorColor, Text = "", Visible = false,
        ...
        {
            Text = "确认并保存", Location = new Point(130, 180), Size = new Size(90, 32), BackColor = ThemeColor,
        ...
        {
            Text = "取消", Location = new Point(230, 180), Size = new Size(90, 32),
            BackColor = Color.FromArgb(225, 225, 225), ForeColor = Color.FromArgb(64, 64, 64),
    ...
    private void ApplyButton_Click(object sender, EventArgs e)
    {
        ...
        if (!int.TryParse(lastOctetTextBox.Text, out var lastOctet))
        {
        ...
        // 冲突检测
        var isConflict = WebRtcVar.PlayerList.Any(p =>
    ...
    private void ShowError(string message)
    {
        ...
        var originalLeft = lastOctetTextBox.Left;
        var t = new Timer { Interval = 40 };
        var count = 0;
        t.Tick += (s, ev) =>
        {
            var offset = count % 2 == 0 ? 4 : -4;
