...
public class NetworkMonitorForm : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        Text = "异地组网状态查看器 - Mcl Network Monitor";
        ...
        try
        {
            miCopyIp.Image = SystemIcons.Application.ToBitmap();
        }
        catch
        {
        }
        ...
        _rowContextMenu.Opening += (s, e) =>
        {
            ...
            var hasValidIp = !string.IsNullOrEmpty(GetSelectedPlayer()?.VirtualIp);
        ...
        Resize += (s, e) => { _btnStop.Location = new Point(bottomPanel.ClientSize.Width - _btnStop.Width - 20, 12); };
    ...
    private LanGamePlayerInfo GetSelectedPlayer()
    {
        if (_dataGridView.SelectedRows.Count > 0)
        {
            ...
            if (index >= 0 && index < WebRtcVar.PlayerList.Count) return WebRtcVar.PlayerList[index];
        }
    ...
    private void CopySelectedPeerId()
    {
        ...
        if (player != null)
        {
            Clipboard.SetText(player.PeerId);
    ...
    public void RefreshPlayerData()
    {
        ...
        if (InvokeRequired)
        {
            ...
            BeginInvoke(new Action(RefreshPlayerData));
            return;
        }
        ...
        try
        {
            ...
            var myPeerId = WebRtcVar.MyPeerId;
            ...
            foreach (var p in players)
            {
                ...
                var statusText = p.Status ?? "在线";
                var isMe = p.PeerId == myPeerId;
        ...
        finally
        {
            ...
            if (!_dataGridView.IsDisposed) _dataGridView.ResumeLayout(true);
        }
    }
