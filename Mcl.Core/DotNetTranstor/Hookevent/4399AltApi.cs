...
namespace DotNetTranstor.Hookevent
{
    internal static class _4399AltApi
    {
        ...
        public static string LoadApiKey()
        {
            ...
            {
                Console.WriteLine($"[4399AltApi] 读取ApiKey失败: {ex.Message}");
                return string.Empty;
            }
        }
        ...
        public static void SaveApiKey(string apiKey)
        {
            ...
            {
                Console.WriteLine($"[4399AltApi] 保存ApiKey失败: {ex.Message}");
                throw;
            }
        }
        ...
        public static bool OpenProfilePage(out string errorMessage)
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine($"[4399AltApi] 打开ApiKey页面失败: {ex.Message}");
                return false;
            }
        }
